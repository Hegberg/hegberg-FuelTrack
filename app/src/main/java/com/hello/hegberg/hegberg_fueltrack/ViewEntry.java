...
public class ViewEntry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //odometerFormat.setRoundingMode(RoundingMode.CEILING);
        //fuelAmountFormat.setRoundingMode(RoundingMode.UP);
        //fuelAmountFormat.setRoundingMode(RoundingMode.UP);
        ...
        //show proper odometer and set proper decimal amount
        ...
        //adapter = new ArrayAdapter<LogEntry>(this, R.layout.list_item, entries);
